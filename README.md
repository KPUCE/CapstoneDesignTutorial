# CapstoneDesignTutorial: 한국공대 캡스톤디자인(종합설계) 가이드
  ...
  * 2027년 1학기 종합설계1을 진행하는 일정으로 정리되어 있습니다. 추후 변경될 수 있으며, 변경사항은 추후 공지하겠습니다.
  * 2027년 종합설계 부터 바뀐 주요 사항: 1-2차 발표(전공지도교수 평가), 3차발표(세션별 평가)
...
### 8. 한국공학대전(TU-EXPO) 전시(4학년 2학기, 9월중)
   * 우수 작품 전시회(체육관)
   * 컴퓨터공학부 작품 전시(실습실)
   * 2025년 디지털전시관(https://expo.tukorea.ac.kr/award): 온라인 전시
